...
public class BasicScenario extends AbstractFreemarkerScenario<BasicScenario.Model> {
    ...
    public static class Player1 {
        ...
        public static class Planet1 {
            public static final Planet PLANET = new Planet(UUID.fromString("ab8657a1-f418-420a-a44a-ab5adeb7f4f1"), new Location(1, 2, 3), PLAYER.getId(), new Resources(100, 200, 300), 1);
        ...
        public static class Planet2 {
            public static final Planet PLANET = new Planet(UUID.fromString("d7bf50da-c073-4d9e-80b7-093297aefc20"), new Location(3, 2, 1), PLAYER.getId(), new Resources(10, 20, 30), 1);
    ...
    public static class Player2 {
        ...
        public static class Planet1 {
            public static final Planet PLANET = new Planet(UUID.fromString("807d6730-a999-11e4-bcd8-0800200c9a66"), new Location(4, 4, 4), PLAYER.getId(), new Resources(100, 200, 300), 1);
        }
