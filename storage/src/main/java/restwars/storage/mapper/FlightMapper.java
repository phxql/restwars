...
public final class FlightMapper {
    ...
    public static Flight fromRecordNoShips(Record record) {
        ...
        return new Flight(id, start, destination, startedInRound, arrivalInRound, Ships.EMPTY, energyNeeded, type, recordPlayerId, direction, new Resources(cargoCrystals, cargoGas, 0), detected);
    }
}
